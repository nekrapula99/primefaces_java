...
@ManagedBean
@SessionScoped
public class SeTfacfc00  extends Control implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	public void init() {
		try {
			...
			//tfacfc00.setMtiptx00(getMtiptx00());
	...
	public void cargarDatos() {
		...
		for(Tfacfc00 obj: listTfacfc00){
			...
			for(Tfadfd00 obj2 : listTfadfd00){
				if(obj2.getTfacfc00().getIdfcfc() == obj.getIdfcfc()){
					if(obj2.getVabrfd()==0.0){
						totalBruto = totalBruto + 0.0;
					}else{
						totalBruto = totalBruto + obj2.getVabrfd();
					}
				}
	...
	public Integer obtenerMayor(Tqigqg00 cotizacionNew) {
		...
		listTfacfc00Aux = tfacfc00Service.listTfacfc00ByCriteria(new Tfacfc00(),getSeControlFactura().getCompaniasUsu());

		for(Tfacfc00 obj: listTfacfc00Aux){
	...
	public void accionModificar(SelectEvent event) {
		try {
			...
			//mensaje = "Desea Continuar generando la factura para esta Cotizacion: "+tfacfc00.getTqigqg00().getNroqqg()+" para el cliente "+tfacfc00.getMgente00().getDctate()+"";
		...
		try {
			update=null;	
				...
				if(getAccion().equals(Constantes.ACCION_MODIFICAR))
				{
					...
					tfacfc00Service.save(tfacfc00,getSeControlFactura().PARAMETROS.get("Reg_Audito").equals("S")?getSeControlFactura().crearAuditoria(null,tfacfc00.toString(),tfacfc00.toStringId(),null):null);
	...
	public SeTfacfc00 getSeTfacfc00() {
		return seTfacfc00;
	}

	public void setSeTfacfc00(SeTfacfc00 seTfacfc00) {
