...
public class Macdio00DaoImpl extends AbstractDAO<Macdio00> implements IMacdio00Dao {
	...
	{		
		...
		String sql = "select codius, dcttus, IDCDIO, DSCDIO, REGDIO, NOMCIA from macdio00, maccio00, mgenus00, mconca00 " +
				     ...
				     "AND CODTUS = 'A5'  AND (IDCMUS = IDMCIO OR (IDCMUS ='' OR IDCMUS IS NULL)) " +
	...
	public Macdio00 getMacdio00ByTqigqg00 (Macdio00 macdio00, String notdio){
		String hql = "SELECT macdio00 FROM Macdio00 AS macdio00 WHERE macdio00.maccio00 =:maccio00 AND macdio00.notdio = '"+notdio+"'";
	    Query query = getSessionFactory().getCurrentSession().createQuery(hql);
	    query.setParameter("maccio00", macdio00.getMaccio00());
	    return (Macdio00) query.uniqueResult();
	}
