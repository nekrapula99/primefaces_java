...
//		}
	...
	@Override
	public List<String> cargarUltimoSufijo (){
		
		List<String> listMtiptx00Sufttx = new ArrayList<String>();
		String hql = "SELECT mtiptx.sufttx FROM Mtiptx00 mtiptx WHERE REGTXT = '1'";
		
	    Query query = getSessionFactory().getCurrentSession().createQuery(hql);
	    listMtiptx00Sufttx = query.list();
	    return  listMtiptx00Sufttx;
	}
	
	@Override
	public Mtiptx00 getMtiptx00ByNotetx(String notetx){
		String hql = "SELECT mtiptx00 FROM Mtiptx00 AS mtiptx00 WHERE mtiptx00.notetx = '"+notetx+"'";
	    Query query = getSessionFactory().getCurrentSession().createQuery(hql);
	    return (Mtiptx00) query.uniqueResult();
	}
